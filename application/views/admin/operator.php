        ...
        <div class="page-inner py-5">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-lg-6">
                        <form action="<?= base_url();?>Admin/search_operator" method="post">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?php echo base_url();?>Admin/operator_save" enctype="multipart/form-data" method="POST">
                                    <div class="row">
                                        <div class="col-sm-12">
                                        ...
                                        <div  class="col-sm-12">
                                            <div class="form-group form-group-default">
                                                <label>Role</label>
                                                <input readonly id="role_name" name="role_name" type="text" class="form-control" value="Operator">
                                            </div>
                                        </div>
