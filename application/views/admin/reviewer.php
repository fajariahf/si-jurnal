                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?php echo base_url();?>Admin/reviewer_save" enctype="multipart/form-data" method="POST">
                                    <div class="row">
                                        <div class="col-sm-12">
                                        ...
                                        <div  class="col-sm-12">
                                            <div class="form-group form-group-default">
                                                <label>Role</label>
                                                <input readonly id="role_name" name="role_name" type="text" class="form-control" value="Reviewer">
                                            </div>
                                        </div>
